...
::dotnet ef migrations add NdtCoreIdentityMigration -c IdentityDbContext -o Persistence/Migrations/AspNetIdentityDb --project ../NDTCore.Identity.Infrastructure
...
::dotnet ef migrations script -c IdentityDbContext -o ../NDTCore.Identity.Infrastructure/Persistence/Migrations/AspNetIdentityDb.sql
...
::Add-Migration NdtCoreIdentityMigration -Context IdentityDbContext -OutputDir Persistence/Migrations/AspNetIdentityDb -Project NDTCore.Identity.Infrastructure
...
::Script-Migration -Context IdentityDbContext -Output ./NDTCore.Identity.Infrastructure/Persistence/Migrations/AspNetIdentityDb.sql
...
dotnet ef migrations add NdtCoreIdentityMigration -c IdentityDbContext -o Persistence/Migrations/AspNetIdentityDb --project %PROJECT_PATH%
...
dotnet ef migrations script -c IdentityDbContext -o %PROJECT_PATH%/Persistence/Migrations/AspNetIdentityDb/AspNetIdentityDb.sql
